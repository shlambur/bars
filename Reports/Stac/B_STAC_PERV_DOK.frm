<div cmptype="Form" class="report_main_div" oncreate="base().onCreate();" dataset="DS_TER_INSP">
  ...
  <!-- если нужна есия, код есть в демо базе FNKC-->
    ...
    <table class="form-table" style="width: 100%;">
        ...
        <tr>
            <td  colspan="2">
               в соответствии с требованиями статьи 9 Федерального закона от 27.07.2006 «О персональных данных» № 152-ФЗ подтверждаю свое согласие на обработку в ФГБУ ФНКЦ ФХМ ФМБА России (далее именуемое «Оператор») моих персональных данных, включающих: фамилию, имя, отчество, пол, дату рождения. адрес проживания, контактный телефон, паспортные данные, реквизиты полиса ОМС (ДМС), страховой номер Индивидуального лицевого счета в Пенсионном фонде России (СНИЛС), данные о состоянии моего здоровья, заболеваниях, случаев обращения за медицинской помощью в медико-профилактических целях, в целях установления медицинского диагноза и оказания медицинских услуг, в целях обработки информации, при условии, что эта обработка осуществляется лицом, уполномоченным Оператором и обязанным сохранять профессиональную тайну.
В процессе оказания Оператором мне медицинской помощи я предоставляю право медицинским работникам передавать мои персональные данные, содержащие сведения, составляющие врачебную тайну, другим должностным лицам Оператора в интересах моего обследования и лечения.
Предоставляю Оператору право осуществлять все действия (операции) с моими персональными данными, включая сбор, систематизацию, накопление, хранение, обработку, обновление, изменение, использование, обезличивание, блокирование, уничтожение. Оператор вправе обрабатывать мои персональные данные посредством внесения их в электронную базу данных, в формы медицинской документации, включая списки (реестры), отчетно-учетные формы, предусмотренные документами, регламентирующими предоставление медицинских услуг, в том числе с перенесением данных на бумажные носители.
Оператор имеет право во исполнение своих обязательств по работе в системе ОМС, по договору на предоставление платных медицинских услуг, по договору ДМС или иному договору на предоставление медицинской помощи (медицинских услуг) на обмен (прием и передачу) моими персональными данными с другим юридическим лицом с использованием бумажных носителей или по каналам, с соблюдением мер, обеспечивающих их защиту от несайкционированного доступа, а также передавать их в ином установленном порядке на бумажных и электронных носителях, при условии, что их прием и обработка будут осуществляться лицами, обязанными сохранять профессиональную тайну. Срок хранения моих персональньж данных соответствуют сроку хранения первичных медицинских документов.
...
<td style="border-bottom: 1px solid black; text-align: center; width: 80%">
    ...
    <div class="shapka">
    <pre>Приложение 3 к Методическим рекомендациям 
    Министр здравоохранения Правительства
    Московской области от 7 августа 2008 г.</pre>
     </div>
...
<tr>
 ...
 Ф.И.О.
        ...
        <td style="width: 20%">
 Представленного мною на основании 
</td>
            <td style="border-bottom: 1px solid black; text-align: center; width: 80%">
        ...
        <tr>
            ...
            <tr>
         <td colspan="2">   а именно, о нижеследующем:
            о наличии, характере, степени тяжести и возможных осложнениях заболеванияо необходимости госпитализации; об общем плане обследования и лечения; о цели, характере, ходе и объеме планируемого обследования, способах его проведения в ходе
...
<tr>
        ...
        <td></td>
            <td  style="font-size: 7pt; text-align: center;">
                (лечащий врач, зав. отделением ЛПУ, другой специалист, принимающий непосредственное участие в обследовании и лечейии)
            </td>
        </tr>
...
на которые таждане дают информированное добровольное согласие при выборе врача и медицинской организации для получения первичной медико-санитарной помощи, утвержденный
 ...
 Федерации 5 мая 2012 г. N 24082) (далее - Перечень), для получения первичной медико-санитарной помощи / получения первичной медикосанитарной помощи лицом, законным 
...
<ol>
  ...
  электрокардиограммы, спирография, пневмотахометрия, пикфлуометрия, рэоэнцефалография, электроэнцефалография, кардиотокрграфия (для беременных).</li>
  <li>Рентгенологические методы обследования, в том числе флюорография (для лиц старше 15 лет) и рентгенография, ультразвуковые исследования,
   допплерографические исследования.</li>
...
Я проинформирован, что:
-	присутствие антител к ВИЧ, эпидемиологических и клинических данных является доказательством наличия ВИЧинфекции;
-	для диспансерного наблюдения, уточнения стадии заболевания и назначения лечения мне необходимо обратиться в Центр по трофилактиже и борьбе со СПИД.
Мне разъяснено, что:
...
Нарушение установленного порядка и невыполнение указанного Федерального Закона влечёт за собой немеденнууд выписку из стационара.
        </p>
