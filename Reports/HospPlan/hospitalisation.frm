		...
		<component cmptype="TabSheet" caption="История болезни" activ="true">
			<table width="98%">
				...
				<tr>
					...
					<td style="padding:3pt" colspan="3">
						<component cmptype="DateEdit" name="HOSPIT_DATE" typeMask="date" onchange="base().onChangeDate();" onblur="base().onChangeDate();" emptyMask="false" readonly="true"/>
						<component cmptype="Edit" name="HOSPIT_HOURS" width="50" typeMask="time" emptyMask="false"/>
					</td>
				</tr>
				<tr>
					<td style="padding:3pt">
